...
export async function getBookByIdRead(id: string) {
  ...
  if (!response.ok) throw new Error("Failed to get book details (read)");
...
export async function getBookById(id: string) {
  ...
  if (!response.ok) throw new Error("Failed to get book by ID");
...
export async function getHighlightAI(data: {
  ...
  if (!response.ok) throw new Error("Failed to get highlight AI");
