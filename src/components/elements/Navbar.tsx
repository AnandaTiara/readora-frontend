...
const Navbar = ({className}:Props) => {
  ...
  return (
    <nav className="fixed w-full top-3 flex justify-center items-center max-w-screen z-40">
      <div className={cn("rounded-xl md:rounded-full px-8 py-1 w-[95%] p-4 backdrop-blur-[19px] bg-white/50", className || "")}>
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-6 text-neutral-900 z-10">
            ...
            <Link to="/Saved" className="hover:text-black"> Saved</Link>
          </div>
